...
namespace StoredProcTest.Migrations
{
    ...
    [Migration("20230904124311_DataAddition")]
    partial class DataAddition
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StoredProcTest.Entities.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            StudentId = new Guid("3763ec80-2d36-47c9-acf7-4a053fb18a1b"),
                            Age = 30,
                            ClassId = 1,
                            Name = "John Doe"
                        },
                        new
                        {
                            StudentId = new Guid("0fdb95e3-af14-45fe-bba9-fcb860708bc4"),
                            Age = 25,
                            ClassId = 2,
                            Name = "Jane Doe"
                        });
